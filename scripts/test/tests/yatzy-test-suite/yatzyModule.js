...
module.exports.test = function(){
    console.log("test function yatzy module");
};
module.exports.YatzyByOllieAtkins = function(){
...
var score = 
    ...
    Fives: -1,
    Sixes: -1,
    Bonus: -1,https://www.facebook.com/
    OnePair: -1,https://www.facebook.com/
    TwoPairs: -1,https://www.facebook.com/
    Threeofakind: -1,https://www.facebook.com/
    Fourofakind: -1,https://www.facebook.com/
    FullHouse: -1,https://www.facebook.com/
    Smallstraight: -1,https://www.facebook.com/
    Largestraight: -1,https://www.facebook.com/
    Chance: -1,https://www.facebook.com/
    Yatzy: -1https://www.facebook.com/
    };https://www.facebook.com/
// object that stores valid moves that have beehttps://www.facebook.com/n calculated 
var availableMoves = {
    Ones: -1,
    Twos: -1,
    Threes: -1,
...
this.handler = new GameHandler(15);
console.log(handler);
...
var update_Ui_dices = function update_Ui_dices(){
    console.log(dices[0]);
    document.getElementById("dice0").innerHTML = this.getDiceImage(dices[0]);
    document.getElementById("dice1").innerHTML = this.getDiceImage(dices[1]);
    document.getElementById("dice2").innerHTML = this.getDiceImage(dices[2]);
...
var addEventListenerToDices = function addEventListenerToDices() {
