...
function validateTurnPhase(){
        ...
        if(turnphaseType === TypeCheckingStrings.number && (turnPhase=== 0 || turnPhase=== 1 || turnPhase===2 ) ){
            return;
        }
        ...
        else if( !(turnPhase=== 0 || turnPhase=== 1 || turnPhase===2) ){
...
this.getDiceImage = function getDiceImage(diceNumber) {
    ...
    if (diceNumber == 1) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_1.png" alt="diceNumber1" >';
    } else if (diceNumber == 2) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_2.png" alt="diceNumber2" >';
    } else if (diceNumber == 3) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_3.png" alt="diceNumber3" >';
    } else if (diceNumber == 4) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_4.png" alt="diceNumber4" >';
    } else if (diceNumber == 5) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_5.png" alt="diceNumber5" >';
    } else if (diceNumber == 6) {
        return '<img src="Yatsy-By-Ollie-Atkins/images/dice_6.png" alt="diceNumber6" >';
    }
}
...
function scoreCard_ClickHandler(row) {
    ...
    console.log("turnphase before: " + turnPhase);
     ...
     if (row.id==='ones' ) {
      ...
      //4.its the end of the game
            ...
            if(MovesLeft.Ones ==true){  
                    ...
                    if(turnPhase==2 && availableMoves.Ones !==-1 && turns >0){
     ...
     if (row.id==='twos' ) {
        if(MovesLeft.Twos ==true){  
            if(turnPhase==2 && availableMoves.Twos !==-1 && turns >0){
    ...
    if (row.id==='fours' ) {
        ...
        if(turnPhase==2 && availableMoves.Fours !==-1 && MovesLeft.Fours ==true && turns >0){
        ...
        //move not available and will give a penalty
        else if(turnPhase==2  && MovesLeft.Fours ==true && turns >0){
         row.lastElementChild.innerHTML = 0;
         MovesLeft.Fours = false; // move has been selected and is no longer available
         row.lastElementChild.innerHTML= score.Fours;
         printMessage("Fail  X");
    ...
    if (row.id==='fives' ) {
        ...
        if(turnPhase==2 && availableMoves.Fives !==-1 && MovesLeft.Fives ==true && turns >0){
        ...
        //move not available and will give a penalty
        else if(turnPhase==2  && MovesLeft.Fives ==true && turns >0){
         row.lastElementChild.innerHTML = 0;
         MovesLeft.Fives = false; // move has been selected and is no longer available
         row.lastElementChild.innerHTML= score.Fives;
         printMessage("Fail  X");
    ...
    if (row.id==='sixes' ) {
        ...
        if(turnPhase==2 && availableMoves.Sixes !==-1 && MovesLeft.Sixes ==true && turns >0){
        ...
        //move not available and will give a penalty
        else if(turnPhase==2  && MovesLeft.Sixes ==true && turns >0){
         row.lastElementChild.innerHTML = 0;
         MovesLeft.Sixes = false; // move has been selected and is no longer available
         row.lastElementChild.innerHTML= score.Sixes;
         printMessage("Fail  X");
...
if (row.id==='onepair' ) {
    ...
    if(turnPhase==2 && availableMoves.OnePair !==-1 && MovesLeft.OnePair ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.OnePair ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.OnePair = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.OnePair;
     printMessage("Fail  X");
...
if (row.id==='twopairs' ) {
    ...
    if(turnPhase==2 && availableMoves.TwoPairs !==-1 && MovesLeft.TwoPairs ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.TwoPairs ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.TwoPairs = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.TwoPairs;
     printMessage("Fail  X");
...
if (row.id==='three-of-a-kind' ) {
    ...
    if(turnPhase==2 && availableMoves.Threeofakind !==-1 && MovesLeft.Threeofakind ==true && turns >0){
    ...
    //not end of turn player is just sketching in the scorecard value: 1 or 2
    if(turnPhase<2  && MovesLeft.Threeofakind ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.Threeofakind ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.Threeofakind = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.Threeofakind;
     printMessage("Fail  X");
    ...
    if(MovesLeft.Fourofakind ==true){ 
        if(turnPhase==2 && availableMoves.Fourofakind !==-1 && MovesLeft.Fourofakind ==true && turns >0){
            ...
            turnPhase = 0;
             ...
             //not end of turn player is just sketching in the scorecard value: 1 or 2
        if(turnPhase<2  && MovesLeft.Fourofakind ==true && turns >0){
...
if (row.id==='full-house' ) {
    ...
    if(turnPhase==2 && availableMoves.FullHouse !==-1 && MovesLeft.FullHouse ==true && turns >0){
     ...
     turnPhase = 0;
      ...
      //not end of turn player is just sketching in the scorecard value: 1 or 2
      if(turnPhase<2  && MovesLeft.FullHouse ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.FullHouse ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.FullHouse = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.FullHouse;
     printMessage("Fail  X");
...
if (row.id==='small-straight' ) {
    ...
    if(turnPhase==2 && availableMoves.Smallstraight !==-1 && MovesLeft.Smallstraight ==true && turns >0){
    ...
    //not end of turn player is just sketching in the scorecard value: 1 or 2
      //not end of turn player is just sketching in the scorecard value: 1 or 2
      if(turnPhase<2  && MovesLeft.Smallstraight ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.Smallstraight ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.Smallstraight = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.Smallstraight;
     printMessage("Fail  X");
...
if (row.id==='large-straight' ) {
    ...
    if(turnPhase==2 && availableMoves.Largestraight !==-1 && MovesLeft.Largestraight ==true && turns >0){
     ...
     turnPhase = 0;
      ...
      //not end of turn player is just sketching in the scorecard value: 1 or 2
      if(turnPhase<2  && MovesLeft.Largestraight ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.Largestraight ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.Largestraight = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.Largestraight;
     printMessage("Fail  X");
...
if (row.id==='chance' ) {
    ...
    if(turnPhase==2 && availableMoves.Chance !==-1 && MovesLeft.Chance ==true && turns >0){
     ...
     turnPhase = 0;
      ...
      //not end of turn player is just sketching in the scorecard value: 1 or 2
      if(turnPhase<2  && MovesLeft.Chance ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.Chance ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.Chance = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.Chance;
     printMessage("Fail  X");
...
if (row.id==='yatzy' ) {
    ...
    if(turnPhase==2 && availableMoves.Yatzy !==-1 && MovesLeft.Yatzy ==true && turns >0){
     ...
     turnPhase = 0;
      ...
      //not end of turn player is just sketching in the scorecard value: 1 or 2
      if(turnPhase<2  && MovesLeft.Yatzy ==true && turns >0){
    ...
    //move not available and will give a penalty
    else if(turnPhase==2  && MovesLeft.Yatzy ==true && turns >0){
     row.lastElementChild.innerHTML = 0;
     MovesLeft.Yatzy = false; // move has been selected and is no longer available
     row.lastElementChild.innerHTML= score.Yatzy;
     printMessage("Fail  X");
...
this.throwDices =  function throwDices() {
    ...
    if(turnPhase ==2){
        this.printMessage("3RD ROLL. SELECT MOVE. " + turns + "TURNS LEFT");
        if (endTurn ==false){  audio.play();};
